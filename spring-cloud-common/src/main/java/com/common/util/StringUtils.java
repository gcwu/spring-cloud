...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
    ...
    public static boolean isOrgCode(String str) {
        ...
        //   (/^[0-9a-zA-Z]{9}$/g .test(value)) || (/^[0-9]{8}-[0-9]{1}$/g .test(value));
        Pattern regex = Pattern.compile("[a-zA-Z0-9]{9}");
        Matcher matcher = regex.matcher(str);
        Pattern regex1 = Pattern.compile("[0-9]{8}-[0-9]{1}");
    ...
    public static String getMd5Sign(String str) {
        return MD5Utils.encode("ifaes_" + str + "_xinzhentech");
    }
    ...
    public static String hideUserName(String userName) {
        ...
        StringBuilder buffer = new StringBuilder(userName.length());
...
//    }
    ...
    /**
     * 选择对象，如果obj1为空，则选obj1,否则选择obj2
     *
     * @param obj1
     * @param obj2
     * @return
     */
    public static String checkObj(Object obj1, Object obj2) {
        return isBlank(obj1) ? isNull(obj2) : isNull(obj1);
    }

    // 将数字转换成字母,0-a,1-b,2-c,等等
    public static String numToLetter(String input) {
        ...
        for (byte b : input.getBytes()) {
            buffer.append((char) (b + 49));
        }
        return buffer.toString();
    }

    /**
     * 判断字符串不等于null，或者trim之后长度大于0
     *
     * @param str
     * @return
     */
     ...
     * @return
     */
    public static boolean isNullObj(String str) {
        return str == null;
    }
